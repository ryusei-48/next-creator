...
export default function PostCardLazy({ isNext, skip, access_token, localePathname, lang, localeStack }: {
  isNext: boolean, skip: number, access_token: string,
  ...
  async function handleMoreButton() {
    const posts = await getPosts( access_token, offset.current + 1, 'post' );
